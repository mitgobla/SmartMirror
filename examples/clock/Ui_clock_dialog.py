...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(121, 76)
        Dialog.setMinimumSize(QtCore.QSize(121, 76))
        Dialog.setMaximumSize(QtCore.QSize(121, 76))
        ...
        self.pushButton_toggle = QtWidgets.QPushButton(Dialog)
        self.pushButton_toggle.setGeometry(QtCore.QRect(0, 42, 121, 31))
        self.pushButton_toggle.setObjectName("pushButton_toggle")

        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        self.thread.start()
        self.pushButton_toggle.pressed.connect(self.clock_update.toggle_format)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Clock"))
        self.label_clock.setText(_translate("Dialog", "Clock"))
        self.pushButton_toggle.setText(_translate("Dialog", "Toggle 24/12hr"))
